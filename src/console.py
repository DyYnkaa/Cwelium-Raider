...
{'╚═╝  ╚═╝╚══════╝╚══════╝╚═╝ ╚═════╝ ╚═╝     ╚═╝'.center(self.size)}"""
    ...
    def raider_options(self):
        ...
        title = f"""
{'╭─────────────────────────────────────────────────────────────────────────────────────────────╮'.center(self.size)}
{'│ «01» Joiner            «06» Token Formatter    «11» ???                 «16» Call Spammer   │'.center(self.size)}
{'│ «02» Leaver            «07» Button Click       «12» ???                 «17» ???            │'.center(self.size)}
{'│ «03» Spammer           «08» Accept Rules       «13» ???                 «18» ???            │'.center(self.size)}
